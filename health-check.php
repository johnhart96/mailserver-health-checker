...
<?php
/**
 * Mail Server Monitor Script
 *
 * Copyright (C) 2025 John Hart
 *
 ...
 *
 * v1.0.0 - 2025-04-24
 *   - Initial release: send test email using PHPMailer
 *   - Check delivery via IMAP
 *   - Alert via BulkSMS on failure
 *
 * v1.1.0 - 2025-04-25
 *   - Added Windows support for curl + cacert.pem
 *   - Added automatic cron job installer
